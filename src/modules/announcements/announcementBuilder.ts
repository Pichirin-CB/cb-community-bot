...
> = {
  ...
  actualizacion: {
    icon: "⚙️",
    color: brand.colors.announcement,
    footer: "CB Studios • Actualizaciones",
    bannerDefault: true,
  },
  mantenimiento: {
    icon: "🔧",
    color: brand.colors.info,
    footer: "CB Studios • Mantenimiento",
    bannerDefault: false,
  },
  desarrollo: {
    icon: "⚙️",
    color: brand.colors.info,
    footer: "CB Studios • Desarrollo",
    bannerDefault: true,
  },
  lanzamiento: {
    icon: "🚀",
    color: brand.colors.success,
    footer: "CB Studios • Lanzamientos",
    bannerDefault: true,
  },
  importante: {
    icon: "⚠️",
    color: brand.colors.warning,
    footer: "CB Studios • Importante",
    bannerDefault: true,
  },
  comunidad: {
    icon: "🌐",
    color: brand.colors.announcement,
    footer: "CB Studios • Web / Sistemas",
    bannerDefault: true,
  },
};
